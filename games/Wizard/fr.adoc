...
Au 2ème tour, on reçoit 2 cartes.
...
Si la première carte jouée est un Papillon, la 2ème carte jouée pourra être de n'importe quelle couleur, c'est cette 2ème carte qui détermine la couleur qui devra être jouée.
Les cartes Papillon ne gagnent jamais le pli.
Une exception néanmoins : si toutes les cartes jouées sont des Papillons, c'est le 1er Papillon qui l'emporte.
